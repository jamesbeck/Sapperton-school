      ...
      <div className="bg-sapperton-green/10 rounded-xl p-8 md:p-12 max-w-5xl mx-auto">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          ...
          <div className="flex flex-col gap-4 text-center flex-1">
            ...
            >
              <span className="text-3xl">&ldquo;</span>I am delighted to be part
              of Sapperton School. It is a small, aspirational school with
              ambition for all. Children experience a rich, varied and vibrant
              curriculum allowing them to flourish.
